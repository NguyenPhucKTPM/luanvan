            ...
            <div class="d-flex flex-column flex-lg-row-fluid py-10">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                        <!--begin::Form-->
                        <form class="form w-100" action="{{route('sendEmailResetPassword')}}" method="POST">
                            @csrf
                            <!--begin::Heading-->
                            <div class="text-center mb-10">
                                ...
                                <!--end::Title-->
                                <!--begin::Link-->
                                <div class="text-gray-400 fw-bold fs-4">Nhập địa chỉ Email đã đăng ký tài khoản để lấy lại mật khẩu</div>
                                <!--end::Link-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-solid" type="email" id="email" placeholder="Nhập địa chỉ email" name="email" autocomplete="off" />
                                @if($errors->has('email'))
                            ...
                            <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                                ...
                                <a href="{{route('dang-nhap')}}" class="btn btn-lg btn-light-primary fw-bolder">Quay lại</a>
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end::Form-->
