...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static   menu-collapsed"
                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2" action="{{route('sendCodeResetPassword')}}"
                                    method="POST">
                                    @csrf
                                    <div class="mb-1">
                                        <label for="forgot-password-email" class="form-label">Mã lấy lại mật
                                            khẩu</label>
                                        <input type="text" class="form-control" id="forgot-password-email" name="code"
                                            placeholder="Nhập 6 số vào đây" aria-describedby="forgot-password-email"
    ...
    <script src="app-assets/js/scripts/countDown.js"></script>
    <!-- END: Page JS-->
