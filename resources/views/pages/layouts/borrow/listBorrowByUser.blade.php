            ...
            <div class="custom-card-body">
                <div class="row d-flex mb-3 ">
                    <div class="col-md-12 col-lg-4 text-dark">
                        <h6 style="color:black;">Mã phiếu mượn: #{{$borrow->maPhieuMuon}}</h6>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-4 text-dark  text-md-center text-left">
                        <h6 style="color:black;">Ngày trả dự kiến: {{ \Carbon\Carbon::parse($borrow->ngayTraDuKien)->format('d/m/Y') }}</h6>
                    </div>
                </div>
                <hr>
