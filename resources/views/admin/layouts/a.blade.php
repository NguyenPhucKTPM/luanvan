        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="grid"></i><span
                    ...
                    <ul class="menu-content">
                        <li class="active"><a class="d-flex align-items-center" href="table-datatable-basic.html"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Basic">Basic</span></a>
                        </li>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="avatar  me-1"><span class="avatar-content">A</span></div>
                                                <div class="d-flex flex-column"><span
                                                        class="emp_name text-truncate fw-bold">abvc222</span><small
                                                        class="emp_post text-truncate text-muted">222</small></div>
                                            </div>
                                        </td>
                                        <td>123qwsed</td>
                                        <td>07/09/2024</td>
                                        ...
                                        <td>
                                            <div class="d-inline-flex"><a
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"><a href="javascript:;"
                                                        ...
                                                        </svg>Details</a><a href="javascript:;"
                                                        class="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg"
                                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round"
